  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn("bg-muted relative grow overflow-hidden rounded-full h-1.5 w-full")}
      >
        <SliderPrimitive.Range data-slot="slider-range" className={cn("bg-primary absolute h-full")} />
      </SliderPrimitive.Track>
